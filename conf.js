...
/*
There are 3 ways to customize conf in modules that use millixcore lib:
...
if (exports.storage === 'mysql'){
	...
	exports.database.name = exports.database.name || 'millix';
	exports.database.user = exports.database.user || 'millix';
}
else if (exports.storage === 'sqlite'){
	exports.database.max_connections = exports.database.max_connections || 1;
	exports.database.filename = exports.database.filename || (exports.bLight ? 'millix-light.sqlite' : 'millix.sqlite');
}
